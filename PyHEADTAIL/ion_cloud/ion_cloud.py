    ...
    def track(self, electron_bunch):
        ...
        if self.ion_beam.macroparticlenumber < self.N_MACROPARTICLES_MAX:
            new_particles = generators.ParticleGenerator(
                                                    ...
                                                    mass=self.A*m_p,
                                                    circumference=self.CIRCUMFERENCE,
                                                    distribution_x=generators.gaussian2D(electron_bunch.epsn_x()/electron_bunch.betagamma),
                                                    alpha_x=0, beta_x=electron_bunch.beta_Twiss_x(),
                                                    distribution_y=generators.gaussian2D(electron_bunch.epsn_y()/electron_bunch.betagamma),
