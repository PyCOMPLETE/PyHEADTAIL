...
class Bunch(object):
    ...
    def compute_statistics(self):
        ...
        cdef list indices
        cdef double stdx2, stdxp2, stdxxp, stdy2, stdyp2, stdyyp
        cdef np.ndarray[double, ndim = 1] x
        cdef np.ndarray[double, ndim = 1] xp
        cdef np.ndarray[double, ndim = 1] y
        cdef np.ndarray[double, ndim = 1] yp
#         cdef double[::1] x
#         cdef double[::1] xp
#         cdef double[::1] y
#         cdef double[::1] yp
...
# cdef double emittance(double[::1] u, double mean_u,
