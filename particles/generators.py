...
class GaussianX(PhaseSpace):
    ...
    def __init__(self, sigma_x, sigma_xp):
    ...
    @classmethod
    def from_optics(cls,  alpha_x, beta_x, epsn_x, betagamma):
...
class GaussianY(PhaseSpace):
    ...
    def __init__(self, sigma_y, sigma_yp):
    ...
    @classmethod
    def from_optics(cls,  alpha_y, beta_y, epsn_y, betagamma):
...
class GaussianZ(PhaseSpace):
    ...
    def __init__(self, sigma_z, sigma_dp, is_accepted = None):
    ...
    @classmethod
    def from_optics(cls,  beta_z, epsn_z, p0,
            is_accepted = None):
        ...
        return cls( sigma_z, sigma_dp, is_accepted)
