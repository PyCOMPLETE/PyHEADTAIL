...
def main():
    ...
    # ==============================================================================================
    # SET UP WAKE FIELDS USING RESISTIVE WALL MODEL.
    # ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    pipe_radius = 0.02
    resistive_wall_length = 26000
    conductivity = 5.4e17
    dz_min = 1e-4
    Yokoya_X1 = 0.5
    Yokoya_Y1 = 0.5
    ...
    wakes = Wakes.resistive_wall(pipe_radius, resistive_wall_length, conductivity, dz_min,
                                 Yokoya_X1, Yokoya_Y1, Yokoya_X2, Yokoya_Y2, slices_for_wakes)
    ...
    dipX_kick_old_version = plt.loadtxt('./resultsOldPyHT/kicks_dipX_resistive_wall.dat')
    dipY_kick_old_version = plt.loadtxt('./resultsOldPyHT/kicks_dipY_resistive_wall.dat')
    quadX_kick_old_version = plt.loadtxt('./resultsOldPyHT/kicks_quadX_resistive_wall.dat')
    quadY_kick_old_version = plt.loadtxt('./resultsOldPyHT/kicks_quadY_resistive_wall.dat')
