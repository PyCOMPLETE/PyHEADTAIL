...
def main():
    ...
    wake_file_columns = ['time', 'dipole_x', 'dipole_y', 'quadrupole_x', 'quadrupole_y',
                         'xterms1', 'xterms2']
    wakes = Wakes.table(wakefile, wake_file_columns, slices_for_wakes)
    ...
    dipX_kick_old_version = plt.loadtxt('./resultsOldPyHT/kicks_dipX_table.dat')
    dipY_kick_old_version = plt.loadtxt('./resultsOldPyHT/kicks_dipY_table.dat')
    quadX_kick_old_version = plt.loadtxt('./resultsOldPyHT/kicks_quadX_table.dat')
    quadY_kick_old_version = plt.loadtxt('./resultsOldPyHT/kicks_quadY_table.dat')
