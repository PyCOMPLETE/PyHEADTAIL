...
class BasicSynchrotron(Element):
    ...
    @property
    def Q_s(self):
        return np.atleast_1d(self.longitudinal_map.Qs)[-1]
    ...
    def _contruct_transverse_map(self,
        optics_mode=None, circumference=None, n_segments=None, s=None, name=None,
        alpha_x=None, beta_x=None, D_x=None, alpha_y=None, beta_y=None, D_y=None,
        accQ_x=None, accQ_y=None, Qp_x=None, Qp_y=None, app_x=None, app_y=None, app_xy=None,
